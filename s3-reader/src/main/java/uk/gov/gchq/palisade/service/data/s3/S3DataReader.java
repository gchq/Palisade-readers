...
public class S3DataReader extends SerialisedDataReader {
     ...
     * Constructor
     *
     * @param properties   contains bucketName, connection detail and headers.
     * @param materialiser is responsible for turning a stream blueprint into a running stream.
