...
class LocalstackS3JUnit5Test {
    ...
    //?? could look into DockerClient to address issue
    @Container
    private static final LocalStackContainer localstack = new LocalStackContainer(DockerImageName.parse("localstack/localstack:0.12.9.1"))
            .withServices(S3);
