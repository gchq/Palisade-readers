...
import uk.gov.gchq.palisade.service.resource.util.PathUtils;
...
public class HadoopResourceServiceTest {
    ...
    public void shouldResolveParents() throws Exception {
        final String testRoot = unixify(testFolder.getRoot().getAbsolutePath());

        final String id = testRoot + "/inputDir/folder1/folder2/" + getFileNameFromResourceDetails(FILE_NAME_VALUE_00001, TYPE_VALUE, FORMAT_VALUE);
        ...
        assertEquals(testRoot + "/inputDir/folder1/folder2/", unixify(parent1.getId()));
        ...
        assertEquals(testRoot + "/inputDir/folder1/", unixify(parent2.getId()));
        ...
        assertEquals(testRoot + "/inputDir/", unixify(parent3.getId()));
        ...
        assertEquals(testRoot + "/", unixify(parent4.getId()));
